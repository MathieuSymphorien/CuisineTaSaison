...
import { FilterSelectComponent } from "src/app/shared/components/filter/filter-select/filter-select";
import { FilterStringComponent } from "src/app/shared/components/filter/filter-string/filter-string";

@Component({
  selector: "app-food-proposal",
  imports: [FilterMonthComponent, FilterSelectComponent, FilterStringComponent],
